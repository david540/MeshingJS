...
/*
pair<vector<int>, vector<int>> compute_j_v(const TriMesh& m, const TriConnectivity& tc, std::vector<vec2>& alpha) {
	...
	prln("Bye !");
	return make_pair(jumpPJ, valence);
}*/
